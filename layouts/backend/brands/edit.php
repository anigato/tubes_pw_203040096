...
$id = $_GET['id'];
$brand = query("select*from brands where id = $id")[0];
?>
...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="text" class="form-control" name="name" id="name" placeholder="Brand Name" value="<?= $brand['name']; ?>" required>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3 mx-auto d-block">
                                                        ...
                                                        <img class="rounded" src="../../../assets/img/brands/<?= $brand['img']; ?>" alt="" style="width: 100%;">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
    ...
    <?php
    if (isset($_POST['edit'])) {
        $upload = uploadImage('../../../assets/img/brands/', $_POST, 'edit-brand');
        if ($upload == "success") {
            echo "
                ...
                Swal.fire({
                    title:'Success!',
                    text:'This Brand Successfully Updated',
                    type:'success',
